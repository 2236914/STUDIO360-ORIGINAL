...
-- STEP 1: Copy and paste this entire file into Supabase SQL Editor
-- STEP 2: Click "Run" button

-- ============================================
-- FINANCIAL FORECASTING FUNCTIONS (FIXED)
-- ============================================
...
-- Test sales forecast
SELECT 'Testing Sales Forecast:' as test_name;
SELECT * FROM get_sales_forecast_data(2025);

-- Test expenses forecast  
SELECT 'Testing Expenses Forecast:' as test_name;
SELECT * FROM get_expenses_forecast_data(2025);

-- Test monthly data
SELECT 'Testing Monthly Sales Data:' as test_name;
SELECT * FROM get_monthly_sales_for_forecast(2025);

SELECT 'Testing Monthly Expenses Data:' as test_name;
SELECT * FROM get_monthly_expenses_for_forecast(2025);

-- ============================================
-- SUCCESS MESSAGE
-- ============================================
SELECT '✅ Financial Forecasting SQL Functions Created Successfully!' as status;
