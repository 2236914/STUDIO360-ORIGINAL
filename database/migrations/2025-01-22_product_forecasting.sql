-- ============================================
-- PRODUCT FORECASTING SQL QUERIES
-- ============================================

-- 1. Get Product Sales Data for Forecasting
-- This query aggregates product sales by month for Prophet forecasting
...
-- 2. Get Category Sales Data for Forecasting
...
-- 4. Get Top Products by Sales (for forecasting)
...
CREATE INDEX IF NOT EXISTS idx_orders_user_id_date ON public.orders (user_id, order_date);
CREATE INDEX IF NOT EXISTS idx_orders_status ON public.orders (status);
CREATE INDEX IF NOT EXISTS idx_inventory_products_user_id_status ON public.inventory_products (user_id, status);

-- 6. Grant permissions (adjust as needed for your setup)
-- GRANT EXECUTE ON FUNCTION get_product_sales_for_forecast TO your_app_user;
-- GRANT EXECUTE ON FUNCTION get_category_sales_for_forecast TO your_app_user;
-- GRANT EXECUTE ON FUNCTION get_inventory_forecast_data TO your_app_user;
-- GRANT EXECUTE ON FUNCTION get_top_products_for_forecast TO your_app_user;
