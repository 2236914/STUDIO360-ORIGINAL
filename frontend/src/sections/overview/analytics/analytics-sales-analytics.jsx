...
// Trimmed per requirement: only keep 360, Shopee, TikTok Shop (removed Shopify & Other)
const SALES_DATA = {
...
export function AnalyticsSalesAnalytics() {
  ...
  const series = [
    { name: '360', data: SALES_DATA.studio360 },
    { name: 'Shopee', data: SALES_DATA.shopee },
    { name: 'TikTok Shop', data: SALES_DATA.tiktokShop },
  ];
